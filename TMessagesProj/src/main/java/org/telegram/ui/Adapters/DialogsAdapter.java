...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter
{
    ...
    public DialogsAdapter(Context context, int type, boolean onlySelect)
    {
        ...
        hasHints = type == MessagesController.DialogType.All && !onlySelect;
        if (onlySelect)
    ...
    {
        hasHints = dialogsType == MessagesController.DialogType.All && !isOnlySelect && !MessagesController.getInstance(currentAccount).hintDialogs.isEmpty();
