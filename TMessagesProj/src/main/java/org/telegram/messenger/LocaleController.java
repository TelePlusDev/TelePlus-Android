...
public class LocaleController
{
    ...
    public static class LocaleInfo
    {
        ...
        {
            if (pathToFile != null && !"remote".equals(pathToFile) && !builtIn)
        ...
        {
            return TextUtils.isEmpty(pathToFile) && !isRemote() && !builtIn;
        }
        ...
        try
        {
                    ...
                    languageCode != null && languageCode.length() > 0)
            {
                ...
                if (languageCode.contains("&") || languageCode.contains("|") ||
                        languageCode.contains("/") || languageCode.contains("\\"))
                {
                    return false;
                }
    ...
    public void applyLanguage(final LocaleInfo localeInfo, boolean override, boolean init,
                              boolean fromFile, boolean force, final int currentAccount)
    {
        ...
        try
        {
            ...
            ApplicationLoader.applicationContext.getResources().updateConfiguration(config,
